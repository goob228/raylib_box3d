...
emcc -o game.html ../main.cpp ../Game.cpp ../Playground.cpp ../Animation.cpp ../Camera.cpp ../EventHandler.cpp ../Prefabs.cpp ../Object.cpp ../LuaBind.cpp ../WindowHandler.cpp %BOX3D_LIB% %RAYLIB_LIB% %LUA_LIB% -Os -O3 -Wall -I%BOX3D_INC% -I%RAYLIB_INC% -I%LUA_INC%  -s USE_GLFW=3 -s ASYNCIFY -DPLATFORM_WEB -DSET_FPS=38 --shell-file ../shell.html --embed-file ./res@res ^
